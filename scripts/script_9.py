# Create aspx_checker.py core module
aspx_checker_code = '''"""
...
<% Response.Write("ASPX Execution Successful - " + DateTime.Now.ToString()); %>'''
...
<body>
<h2>ASPX Execution Test - Extended</h2>
<script runat="server">
void Page_Load(object sender, EventArgs e) {
    lblTime.Text = DateTime.Now.ToString();
    lblServer.Text = Request.ServerVariables["SERVER_SOFTWARE"];
    lblFramework.Text = Environment.Version.ToString(); 
    lblPath.Text = Server.MapPath(".");
    try {
        lblUser.Text = Environment.UserName;
        lblMachine.Text = Environment.MachineName;
    } catch { lblUser.Text = "N/A"; lblMachine.Text = "N/A"; }
}
</script>
<p>Current Time: <asp:Label ID="lblTime" runat="server" /></p>
<p>Server Software: <asp:Label ID="lblServer" runat="server" /></p>
<p>.NET Framework: <asp:Label ID="lblFramework" runat="server" /></p>
<p>Current Path: <asp:Label ID="lblPath" runat="server" /></p>
<p>User: <asp:Label ID="lblUser" runat="server" /></p>
<p>Machine: <asp:Label ID="lblMachine" runat="server" /></p>
</body>
</html>'''
...
Harmless reconnaissance payload
-->
<!DOCTYPE html>
<html>
...
<p>Directory: <asp:Label ID="lblDirectory" runat="server" /></p>
<!-- Migr8 ASPX Test Payload -->
</body>
</html>'''
