# Create contenttype_bypass.py core module
contenttype_bypass_code = '''"""
...
with open("migr8/core/contenttype_bypass.py", 'w') as f:
    f.write(contenttype_bypass_code)
print("Created: migr8/core/contenttype_bypass.py")